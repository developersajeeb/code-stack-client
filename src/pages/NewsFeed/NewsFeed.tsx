                                ...
                                <div key={question?._id} className="py-4 border-b md:flex justify-between gap-6 items-center">
                                    <div>
                                        <Link to={`/news-feed/${question?._id}`} onClick={() => incrementViewCount(question?._id)}>
                                            <h2 className="text-xl font-semibold hover:text-[#33B89F] cursor-pointer duration-200 inline-block">{question?.title}</h2>
                                        </Link>
                                        ...
                                        <ul className="flex flex-wrap gap-2 my-3 mt-5">
                                            {
                                                question?.selected?.map((tag: string, index: number) => <Link
                                                    key={index}
                                                    to={`/tagged?tag=${tag}`}>
                                                    <li className="hover:bg-indigo-50 hover:border-[#02B1FC] hover:text-[#33B89F] duration-200 bg-white border border-gray-400 px-3 text-xs py-1 text-gray-400 rounded-full font-medium cursor-pointer">{tag}</li>
                                                </Link>)
                                            }
                                        </ul>
                                        <p className="flex items-center flex-wrap gap-2 mt-5 text-sm">
                                            ...
                                            <span>| <Link className="text-[#02B1FC]" to={`/news-feed/${question?._id}`} onClick={() => incrementViewCount(question?._id)}>View details</Link></span>
                                        </p>
                                    </div>
