            ...
            <div className="border p-4 rounded-lg text-2xl font-medium bg-gray-50 mt-8 pb-20">
                ...
                <div className="flex justify-center">
                    <p className="text-sm mt-4 text-gray-500 text-center">
                        ...
                        <p className="w-full md:w-96 mt-3">Your most helpful questions, answers and tags will appear here. Start by <Link to='/ask-question'><span className="ml-1 text-orange-400 cursor-pointer">answering a question</span></Link> or selecting tags that match topics you’re interested in.</p>
                    </p>
                </div>
            </div>
        </main>
