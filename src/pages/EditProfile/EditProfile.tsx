        ...
        <main>
            ...
            <form onSubmit={handleUpdateDetails} className="mt-10">
                ...
                <div className="my-6">
                    ...
                    <textarea className="border-2 border-gray-300 rounded-md w-full py-3 px-5 mt-2 focus:border-2 text-sm" name="aboutMe" id="" cols="30" rows="6" placeholder="About Yourself"></textarea>
                </div>
