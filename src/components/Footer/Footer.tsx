                    ...
                    <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form className="w-full flex items-center">
                                <input placeholder='Your Mail' className='text-sm  px-6 py-4 w-full rounded-full' type="email" name="" id="" />
                                <button className="px-6 pr-9 py-3 ml-3 relative rounded-full group overflow-hidden font-medium primary-bg text-white mr-4">
                                    ...
                                    <span className="relative group-hover:text-[#0278AE]">Subscribe</span>
                                </button>
                            </form>
                        </div>
                ...
                <div className="mt-8 border-t border-gray-100 pt-8">
                    <div className="sm:flex sm:justify-between">
                        <p className="text-xs text-gray-500">
                            &copy; 2023. CodeStack. All rights reserved.
                        </p>
